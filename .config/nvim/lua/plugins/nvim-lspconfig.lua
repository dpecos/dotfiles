...
local on_lsp_attach = function(event)
	...
	map_lsp("gDv", ":vsplit | lua vim.lsp.buf.declaration()<CR>", "[G]oto [D]eclaration (vertical split)")
	map_lsp("gd", vim.lsp.buf.definition, "[G]oto [D]efinition")
	map_lsp("gdv", ":vsplit | lua vim.lsp.buf.definition()<CR>", "[G]oto [D]efinition (vertical split)")
	map_lsp("grr", require("telescope.builtin").lsp_references, "List [R]eferences")
	map_lsp("gri", require("telescope.builtin").lsp_implementations, "List [I]mplementation")
	...
	map_lsp("gO", require("telescope.builtin").lsp_document_symbols, "List [D]ocument [S]ymbols")
	map_lsp("grn", vim.lsp.buf.rename, "[R]e[n]ame")
	map_lsp("gra", vim.lsp.buf.code_action, "Code [A]ction")
